...
public class MyWebMagicTest02 implements PageProcessor {
    ...
    public static void main(String[] args) {
        Spider.create(new MyWebMagicTest02()).addUrl("http://blog.sina.com.cn/s/articlelist_1487828712_0_1.html").run();
    }
}
